from peft import PEFT_CONFIG_MAPPING
...
@dataclass
class PeftTrainingArguments:
    """Defines the adapters parameters."""
    ablation:Optional[int] = field(default=0,
                                                metadata={"help": "Ablation in the model.  0 no ablation"})
    ...
    peft_config_name: Optional[str] = field(
        default="adapter", metadata={"help": "config name for the adapter layers, should be selected "
                                     f"in {sorted(PEFT_CONFIG_MAPPING.keys())}."}
    )
    ...
    task_reduction_factor: Optional[int] = field(default=16, metadata={"help": "defines the default reduction factor for "
                                                                       "adapter layers."})
    non_linearity: Optional[str] = field(default="gelu_new", metadata={
...
class TrainingArguments(Seq2SeqTrainingArguments):
    ...
    only_save_best_checkpoint: bool = field(
        default=True,
        metadata={
            "help": "only save_best_checkpoint"
        },
    )
    ...
    is_logger: bool = field(
        default=False,
        metadata={
            "help": "logger soft prompt group information"
        },
    )
...
class ModelArguments:
    ...
    multi_task: bool = field(
        default=False,
        metadata={
            "help": "run multi-task transfer"
        },
    )
    
    multi_task_names: Optional[List[str]] = field(
        default=False,
        metadata={
            "help": "source task name for prompt_embedding_path"
        },
    ) # type: ignore
    ...
    load_target_task_name: Optional[str] = field(
        default=None,
        metadata={
            "help": "target task name for prompt_embedding_path if None task name equal target name"
        },
    ) # type: ignore
    ...
    target_task_scale_learning_rate: Optional[float] = field(
        default=None, metadata={"help": "the number of prefix"})
    
    source_task_scale_learning_rate: Optional[float] = field(
        default=None, metadata={"help": "the number of prefix"})
